                    ...
                    <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                        <div class="product product-style-3 equal-elem ">
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span> {{ $lens->company}} : اسم الشركة  , {{ $lens->lens_name}} :  اسم العدسة </span></a>
                                <a href="#" class="product-name"><span>CYL: {{ $lens->cyl}}  , SPH: {{ $lens->sph }}</span></a>
                                <a href="#" class="product-name"><span>Index: {{ $lens->index}}  ,  {{ $lens->lens_option }} : خيار العدسة </span></a>
