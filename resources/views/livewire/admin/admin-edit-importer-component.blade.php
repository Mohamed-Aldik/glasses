                            ...
                            <div class="register-form form-item ">
                                <form class="form-stl" name="frm-login" wire:submit.prevent="updateCustomer">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="text" id="frm-reg-lname" wire:model="name" :value="old('name')" required autofocus autocomplete="name" placeholder="{{ __('messages.name') }}*">
                                    @error('name')<p class="text-danger">{{$message}}</p>
        @enderror
                                    </fieldset>
                                    <fieldset class="wrap-input item-width-in-half left-item ">
                                        <label for="frm-reg-email">{{ __('messages.email') }}*</label>
                                        <input type="email" id="frm-reg-email" wire:model="email" :value="old('email')" required  placeholder="{{ __('messages.email') }}">
                                    @error('email')<p class="text-danger">{{$message}}</p>
        @enderror
                                    </fieldset>
                                     <fieldset class="wrap-input item-width-in-half ">
                                        <label for="frm-reg-email">{{ __('messages.phone') }}*</label>
                                        <input type="text" id="frm-reg-email" wire:model="phone" :value="old('phone')" required  placeholder="{{ __('messages.phone') }}">
...
{{-- 
        ...
        @enderror
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="approved" wire:model="approved" id="exampleRadios1"
                                            value="1" >
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="approved" wire:model="approved" id="exampleRadios2"
                                            value="0" >
